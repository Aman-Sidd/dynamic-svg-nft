-include .env
.PHONY: update anvil deploy test test-zksync deploySepolia
...
deploySepolia:; forge script script/DeployMoodNft.s.sol:DeployMoodNftScript --rpc-url ${SEPOLIA_RPC_URL} --account my-account --etherscan-api-key ${ETHERSCAN_API_KEY} --verify --broadcast